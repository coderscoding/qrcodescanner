...
(function () {
        ...
        z = y ? x : function () {
            ...
            function a() {
                try {
                    ...
                    this._elImage.src = a, this.dataURL = a, this._elImage.style.display = "inline", this._elCanvas.style.display = "none"
                } catch (a) {
                    console.error(a)
                }
            ...
            var e = function (a, b) {
                this._bIsPainted = !1, this._android = f(), this._htOption = b, this._elCanvas = document.createElement("canvas"), a.appendChild(this._elCanvas), this._el = a, this._oContext = this._elCanvas.getContext("2d"), this._bIsPainted = !1, this._elImage = document.createElement("img"), this._elImage.alt = "Scan me!", this._elImage.style.display = "none", this._el.appendChild(this._elImage), this._bSupportDataURI = null, this.dataURL = null
            };
            return e.prototype.draw = function (a) {
                ...
                function c(a) {
                    function c(a) {
                        var c = Math.round(f.width / 3.5),
                            d = Math.round(f.height / 3.5);
                        c !== d && (c = d), f.logoWidth && (c = Math.round(f.logoWidth)), f.logoHeight && (d = Math.round(f.logoHeight));
                        var g = (f.width + 2 * f.quietZone - c) / 2,
                            h = (f.height + f.titleHeight + 2 * f.quietZone - d) / 2;
                        f.logoBackgroundTransparent || (e.fillStyle = f.logoBackgroundColor, e.fillRect(g, h, c, d));
                        var i, j;
                        void 0 === a.naturalWidth ? (i = a.width, j = a.height) : (i = a.naturalWidth, j = a.naturalHeight);
                        var k = Math.min(c / i, d / j),
                            l = i * k,
                            m = j * k;
                        e.drawImage(a, g + (c - l) / 2, h + (d - m) / 2, l, m), f.quietZone > 0 && f.quietZoneColor && b(), u._bIsPainted = !0, u.makeImage()
                    }
                ...
                f.width = h * g, f.height = i * g + f.titleHeight, f.quietZone = Math.round(f.quietZone), this._elCanvas.width = f.width + 2 * f.quietZone, this._elCanvas.height = f.height + 2 * f.quietZone, d.style.display = "none", this.clear(), e.lineWidth = 0, e.fillStyle = f.colorLight, e.fillRect(0, 0, this._elCanvas.width, this._elCanvas.height);
                var j = this;
            ...
            return a.prototype.draw = function (a) {
                ...
                if (g.push("</table>"), g.push("</div>"), b.logo) {
                    ...
                    var y = "position:relative; z-index:1;display:table-cell;top:-" + ((b.height - b.titleHeight) / 2 + x / 2 + b.quietZone) + "px;text-align:center; width:" + w + "px; height:" + x + "px;line-height:" + w + "px; vertical-align: middle;";
                    b.logoBackgroundTransparent || (y += "background:" + b.logoBackgroundColor), g.push('<div style="' + y + '"><img  src="' + b.logo + '"  style="max-width: ' + w + "px; max-height: " + x + 'px;" /> <div style=" display: none; width:1px;margin-left: -1px;"></div></div>')
                }
                ...
                A > 0 && B > 0 && (z.style.margin = B + "px " + A + "px"), this._htOption.onRenderingEnd && this._htOption.onRenderingEnd(this._htOption, null)
            }, a.prototype.clear = function () {
                this._el.innerHTML = ""
            }, a
        }();
    j = function (a, b) {
        ...
        this._oQRCode = new b(g(a, this._htOption), this._htOption.correctLevel), this._oQRCode.addData(a), this._oQRCode.make(), this._htOption.tooltip && (this._el.title = a), this._oDrawing.draw(this._oQRCode)
